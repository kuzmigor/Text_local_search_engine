...
class InvertedIndex
{
    ...
    std::vector<std::string>                  m_vDocs {}; // список содержимого документов
    std::map<std::string, std::vector<Entry>> m_FreqDictionary {}; // частотный словарь (слово, (документ, количество))
